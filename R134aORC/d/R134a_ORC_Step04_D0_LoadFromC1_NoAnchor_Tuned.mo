model R134a_ORC_Step04_D0_LoadFromC1_NoAnchor_Tuned
  "D0：NoAnchor 基线的小步二阶优化版（温和放大局部体积/通道 + 放缓热侧时序）"
  ...
  parameter Real hotFlowHeight = 0.50
    "热源增量";
  parameter Real hotFlowDuration = 120
    "热源流量爬升时长（由60放缓到120）";
  ...
  parameter Real hotTHeight = 10.0
    "热源升温增量（到303.15 K）";
  parameter Real hotTDuration = 300
    "热源升温时长（由150放缓到300）";
  ...
  // D. 二阶优化参数（小步，不激进）
  // ======================================================================
  parameter SI.Volume V_header = 0.005
    "高低压 header 体积：0.001 -> 0.005";
  parameter SI.Volume V_turbinePlenum = 0.003
    "透平入口前室体积：0.001 -> 0.003";
  parameter SI.Length d_branch = 0.03
    "高低压短管直径：0.02 -> 0.03";
...
end R134a_ORC_Step04_D0_LoadFromC1_NoAnchor_Tuned;