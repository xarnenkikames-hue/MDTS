model R134a_ORC_Step04_D0_LoadFromC1_NoAnchor_hotT300
  "D0：NoAnchor 原版回归，只将 hotTDuration 从150改为300"
  ...
  parameter Real hotTOffset = 293.15
    "热源初始温度";
  parameter Real hotTHeight = 15.0
    "热源升温增量（到 303.15 K）";
  parameter Real hotTDuration = 200
    "热源升温时长（仅此处由150改为300）";
...
end R134a_ORC_Step04_D0_LoadFromC1_NoAnchor_hotT300;