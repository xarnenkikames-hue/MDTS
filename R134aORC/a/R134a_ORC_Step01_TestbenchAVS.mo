model R134a_ORC_Step01_TestbenchAVS "扩容"

  import SI = Modelica.SIunits;

  annotation(
    __MWORKS(version="26.1.3",ContinueSimConfig(SaveContinueFile="false",SaveBeforeStop="false",NumberBeforeStop=1,FixedContinueInterval="false",ContinueIntervalLength=2,ContinueTimeVector)),
    Diagram(coordinateSystem(extent={{-100,-100},{100,100}}, grid={2,2})),
    experiment(Algorithm=Dassl,StartTime=0,StopTime=1000,Tolerance=0.0001,InlineIntegrator=false,InlineStepSize=false,NumberOfIntervals=5000,StoreEventValue=0));
...
end R134a_ORC_Step01_TestbenchAVS;